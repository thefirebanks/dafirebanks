...
<Meta 
  title="Homepage"
  description="this website has stuff about me and the work ive done." 
/>
...
<div class="flex flex-col items-center">
  ...
  <h3 class="py-2 text-xl text-center">
    this website has stuff about me and the work ive done.
  </h3>
</div>
<div class="bg-secondary-50 relative px-4 pt-6 pb-4 mt-10 mb-2">
...
<ul class="inline-flex flex-col ml-8 list-disc">
  <li style="text-decoration: line-through;">add posts about things</li>
